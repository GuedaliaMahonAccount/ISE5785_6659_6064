// renderer/StreetSceneNoThreadsTest.java
package renderer;
...
/**
 * Test class for rendering a colorful, realistic street scene
 * without multithreading and without BVH acceleration,
 * including a rocket launch and a windowed building.
 */
public class StreetSceneNoThreadsTest {

    private final Scene scene = new Scene("Colorful Realistic Street Scene with Rocket and Windows (No Threads, No BVH)");
    ...
    public void streetScene() {
        ...
        createRocket(
                geometries,
                new Point(0, 70, -100),       // nose tip
                new Vector(0, -0.2, -1),      // direction
                0.7                            // scale
        );
        ...
        // Windowed building
        createBuildingWithWindows(geometries,
                new Point(-80,  0, -350),
                60,120, 40,
                new Color(160, 80,  60)
        );
        // Non-reflective plain
        ...
        // ===== Attach raw geometries directly (no BVH) =====
        ...
        camera.writeToImage("streetNoThreadsNoBVH");
        System.out.println("Image written to file: streetNoThreadsNoBVH.png");
    }
