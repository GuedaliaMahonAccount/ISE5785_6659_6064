...
/**
 * Test class for rendering a colorful, realistic street scene with a crescent moon,
 * a rocket launch, and a windowed building, using BVH acceleration but without multithreading.
 */
public class StreetSceneBVHNoThreadTest {

    private final Scene scene = new Scene("Colorful Realistic Street Scene with Rocket, Windows & Crescent Moon");
    ...
    public void streetScene() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            scene.lights.add(
                    new PointLight(new Color(100,90,80), new Point(-50, 9.2, zL))
                            .setKl(0.001).setKq(0.0005).setRadius(10.0).setNumSamples(5)
            );
            scene.lights.add(
                    new PointLight(new Color(100,90,80), new Point( 55, 9.2, zR))
                            .setKl(0.001).setKq(0.0005).setRadius(10.0).setNumSamples(5)
            );
        }
        scene.lights.add(
        ...
        camera.writeToImage("streetBVHNoThreads");
        System.out.println("Image written to file: streetBVHNoThreads.png");
    }
