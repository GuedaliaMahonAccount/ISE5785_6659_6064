...
public class GeometriesTests {
    ...
    public void testFindIntersections() {
        ...
        List<GeoPoint> result2 = geoTriangleOnly.findIntersections(ray2);
        ...
        List<GeoPoint> result3 = geo.findIntersections(ray3);
        ...
        List<GeoPoint> result4 = geo.findIntersections(ray4);
